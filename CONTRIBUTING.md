...
> Wolfram may release your contribution under the terms of the [GPL license](https://opensource.org/licenses/gpl-license); and

> You have read and agreed to the [Developer Certificate of Origin](http://developercertificate.org/), version 1.1 or later.

Please see [LICENSE.txt](LICENSE.txt) for licensing conditions pertaining
